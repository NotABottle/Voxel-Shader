...
public class VoxelizedMesh : MonoBehaviour
{
    ...
    [SerializeField][Range(0.005f,0.05f)] float _halfSize = 0.05f;
    ...
    void Update()
    {
        ...
        if (_drawDebug)
        {
            ...
            Graphics.DrawProceduralIndirect(_gridPointMaterial, _meshCollider.bounds, MeshTopology.Points, _pointsArgsBuffer);
